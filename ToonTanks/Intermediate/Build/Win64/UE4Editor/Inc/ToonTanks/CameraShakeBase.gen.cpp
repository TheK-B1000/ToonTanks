...
// Cross Module References
	TOONTANKS_API UClass* Z_Construct_UClass_UCameraShakeBase_NoRegister();
	TOONTANKS_API UClass* Z_Construct_UClass_UCameraShakeBase();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCameraShakeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "General/CameraShakeBase.h" },
		{ "ModuleRelativePath", "General/CameraShakeBase.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UCameraShakeBase, 1558590588);
	template<> TOONTANKS_API UClass* StaticClass<UCameraShakeBase>()
	{
		return UCameraShakeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCameraShakeBase(Z_Construct_UClass_UCameraShakeBase, &UCameraShakeBase::StaticClass, TEXT("/Script/ToonTanks"), TEXT("UCameraShakeBase"), false, nullptr, nullptr, nullptr);
